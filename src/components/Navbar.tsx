          ...
          <div className="pt-3 border-t border-slate-100 dark:border-slate-800 space-y-2">
            ...
            <div className="flex items-center justify-center gap-2.5">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#1877F2] to-[#0A66C2] text-white flex items-center justify-center shadow-md shadow-blue-500/25 active:scale-95 transition-transform"
                aria-label="Facebook Profile"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white flex items-center justify-center shadow-md shadow-pink-500/25 active:scale-95 transition-transform"
                aria-label="Instagram Profile"
              >
                <Instagram className="w-4 h-4" />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-gradient-to-tr from-black via-slate-900 to-slate-800 text-white flex items-center justify-center shadow-md shadow-slate-900/30 active:scale-95 transition-transform border border-slate-700"
                aria-label="X (Twitter) Profile"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-gradient-to-tr from-black via-slate-900 to-zinc-800 text-white flex items-center justify-center shadow-md shadow-slate-900/30 active:scale-95 transition-transform border border-slate-700"
                aria-label="Threads Profile"
              >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#0d1117] to-[#24292f] text-white flex items-center justify-center shadow-md shadow-slate-900/30 active:scale-95 transition-transform border border-slate-700"
              aria-label="GitHub Profile"
            >
              <Github className="w-4 h-4" />
            </a>
