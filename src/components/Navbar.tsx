    ...
    <header className="sticky top-0 z-50 bg-white/95 dark:bg-slate-950/95 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-800 shadow-xs transition-colors duration-200 notranslate" translate="no">
      <div className="max-w-6xl mx-auto px-3.5 sm:px-6">
        <div className="flex items-center justify-between h-14 sm:h-18 md:h-20">
          ...
          {/* Desktop Right Side: Social Links & Theme Toggle */}
          <div className="hidden sm:flex items-center gap-2">
            ...
            <a
              ...
              className="w-8 h-8 rounded-lg bg-gradient-to-tr from-black via-slate-900 to-zinc-800 text-white flex items-center justify-center shadow-xs hover:scale-105 transition-all border border-slate-700"
            >
              <svg className="w-3.5 h-3.5 fill-white" viewBox="0 0 192 192">
            ...
            <ThemeToggle variant="icon" className="ml-1" />
          </div>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 pt-3 pb-6 space-y-4 shadow-2xl max-h-[85vh] overflow-y-auto">
          ...
          <div className="pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-center gap-3">
            <a
              href="https://www.facebook.com/aabiral.bhatt/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#1877F2] to-[#0A66C2] text-white flex items-center justify-center shadow-md shadow-blue-500/25 border border-blue-400/30 active:scale-95 transition-transform"
              aria-label="Facebook"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white flex items-center justify-center shadow-md shadow-pink-500/25 border border-pink-400/30 active:scale-95 transition-transform"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-xl bg-gradient-to-tr from-black via-slate-900 to-slate-800 text-white flex items-center justify-center shadow-md shadow-slate-900/30 border border-slate-700 active:scale-95 transition-transform"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-xl bg-gradient-to-tr from-black via-slate-900 to-zinc-800 text-white flex items-center justify-center shadow-md shadow-slate-900/30 border border-slate-700 active:scale-95 transition-transform"
              aria-label="Threads"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#0d1117] to-[#24292f] text-white flex items-center justify-center shadow-md shadow-slate-900/30 border border-slate-700 active:scale-95 transition-transform"
              aria-label="GitHub"
            >
