...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-slate-950 text-slate-300 border-t border-slate-800 overflow-hidden notranslate" translate="no">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-10 sm:pt-12 pb-6 sm:pb-8 relative z-10">
        
        {/* Main 3-Column Compact & Balanced Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 pb-8 sm:pb-10 border-b border-slate-800/80 items-start">
          ...
          <div className="space-y-4 text-center sm:text-left">
            ...
            <p className="text-xs sm:text-sm text-slate-300 dark:text-slate-200 leading-relaxed max-w-sm mx-auto sm:mx-0">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-2 pt-1 flex-wrap">
              ...
              <a
                ...
                className="w-8 h-8 rounded-lg bg-gradient-to-tr from-[#1877F2] to-[#0A66C2] text-white flex items-center justify-center shadow-sm hover:scale-110 active:scale-95 transition-all border border-blue-400/30 shrink-0"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-lg bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white flex items-center justify-center shadow-sm hover:scale-110 active:scale-95 transition-all border border-pink-400/30 shrink-0"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-lg bg-gradient-to-tr from-black via-slate-900 to-slate-800 text-white flex items-center justify-center shadow-sm hover:scale-110 active:scale-95 transition-all border border-slate-700 shrink-0"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-lg bg-gradient-to-tr from-black via-slate-900 to-zinc-800 text-white flex items-center justify-center shadow-sm hover:scale-110 active:scale-95 transition-all border border-slate-700 shrink-0"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-lg bg-gradient-to-tr from-[#0d1117] via-[#161b22] to-[#24292f] text-white flex items-center justify-center shadow-sm hover:scale-110 active:scale-95 transition-all border border-slate-700 shrink-0"
          ...
          <div className="space-y-3.5 text-center sm:text-left">
            ...
            <div className="space-y-2.5">
              ...
              <a
                ...
                className="flex items-center justify-center sm:justify-start gap-2 p-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 text-xs text-slate-200 hover:text-emerald-300 transition-all group"
              >
              ...
              {/* Status Pill */}
              <div className="flex items-center justify-center sm:justify-start gap-2 p-2.5 rounded-xl bg-slate-900 border border-slate-700 text-xs text-slate-200">
        ...
        <div className="py-5 border-b border-slate-800 flex flex-wrap items-center justify-center gap-y-2 gap-x-4 sm:gap-x-6 text-[11px] sm:text-xs text-slate-300">
        ...
        <div className="pt-6 sm:pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400 text-center sm:text-left">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <button
              onClick={scrollToTop}
              className="inline-flex items-center gap-1.5 font-bold text-slate-200 hover:text-white px-3.5 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 active:scale-95 transition-all border border-slate-700 shadow-sm"
            >
