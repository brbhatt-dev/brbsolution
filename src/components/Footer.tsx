          ...
          <div className="lg:col-span-2 space-y-3.5 text-center sm:text-left">
            ...
            <div className="flex flex-col gap-2 max-w-[200px] mx-auto sm:mx-0">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2.5 px-3 py-2 rounded-xl bg-gradient-to-r from-black via-slate-900 to-zinc-800 text-white text-xs font-bold shadow-md shadow-slate-950/30 hover:shadow-slate-950/50 hover:scale-[1.02] active:scale-[0.98] transition-all border border-slate-700"
              >
