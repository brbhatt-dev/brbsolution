...
import { Compass, Download, Play, CheckCircle2, Calculator, Layers, ArrowRight, X, ExternalLink } from 'lucide-react';
    ...
    <section id="land-solution" className="py-16 md:py-24 bg-white border-t border-slate-100">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="rounded-3xl bg-gradient-to-br from-emerald-600 via-teal-700 to-slate-900 text-white p-8 sm:p-12 mb-16 shadow-xl shadow-emerald-900/10 relative overflow-hidden">
          <div className="relative z-10 max-w-2xl space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              ...
              <a
                href="/downloads/Land_Solution.apk"
                download
              ...
              >
                ...
                <span>Android APK डाउनलोड गर्नुहोस्</span>
              </a>
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 text-xs text-emerald-200 hover:text-white underline font-medium"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Built-in Live Interactive Land Converter */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                ...
                <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-sm">
                  ...
                  <p className="text-lg font-extrabold text-slate-900 mt-1 font-mono">
                    {ropani} <span className="text-xs font-normal text-slate-500">रोपनी</span> {aana} <span className="text-xs font-normal text-slate-500">आना</span> {paisa} <span className="text-xs font-normal text-slate-500">पैसा</span> {daam} <span className="text-xs font-normal text-slate-500">दाम</span>
                  </p>
                  <p className="text-[11px] text-slate-400 mt-1">
                    १ रोपनी = ५,४७६ वर्गफिट
                  </p>
                </div>
                ...
                <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-sm">
                  ...
                  <p className="text-lg font-extrabold text-slate-900 mt-1 font-mono">
                    {bigha} <span className="text-xs font-normal text-slate-500">बिघा</span> {katha} <span className="text-xs font-normal text-slate-500">कट्ठा</span> {dhur} <span className="text-xs font-normal text-slate-500">धुर</span>
                  </p>
                  <p className="text-[11px] text-slate-400 mt-1">
                    १ बिघा = ७२,९०० वर्गफिट
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 bg-slate-50">
              ...
              <div className="flex items-center gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs text-blue-600 hover:underline inline-flex items-center gap-1 font-medium px-2 py-1"
                >
